...
class BackendAPITester:
    ...
    def test_subscription_status_unauthorized(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                self.log_test("Subscription Status - Unauthorized", True, f"Correctly rejected unauthenticated request ({response.status_code})")
            else:
                self.log_test("Subscription Status - Unauthorized", False, f"Expected 401/403, got {response.status_code}")
    ...
    def test_paypal_create_payment_unauthorized(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                self.log_test("PayPal Create Payment - Unauthorized", True, f"Correctly rejected unauthenticated request ({response.status_code})")
            else:
                self.log_test("PayPal Create Payment - Unauthorized", False, f"Expected 401/403, got {response.status_code}")
    ...
    def test_paypal_execute_payment_unauthorized(self):
        ...
        try:
            ...
            if response.status_code in [401, 403]:
                self.log_test("PayPal Execute Payment - Unauthorized", True, f"Correctly rejected unauthenticated request ({response.status_code})")
            else:
                self.log_test("PayPal Execute Payment - Unauthorized", False, f"Expected 401/403, got {response.status_code}")
