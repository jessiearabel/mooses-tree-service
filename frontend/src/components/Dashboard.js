      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-900">
              {user.progress.completedQuestions}/{user.progress.totalQuestions}
            </div>
            <Progress 
            ...
            <p className="text-xs text-blue-600 mt-2">
              {Math.round((user.progress.completedQuestions / user.progress.totalQuestions) * 100)}% completado
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200">
          ...
          <CardContent>
            ...
            <Progress value={user.progress.averageScore} className="mt-2" />
            <p className="text-xs text-emerald-600 mt-2">
              {user.progress.averageScore >= 70 ? 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="text-center">
                ...
                <div className="text-xs opacity-90">50 {t.questions}, 30 {t.minutes}</div>
              </div>
            </Button>
            ...
            >
              <div className="text-center">
                ...
                <div className="text-xs text-blue-600">100 {t.questions}, 60 {t.minutes}</div>
              </div>
            </Button>
                  ...
                  <div key={result.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <div className="text-xs text-gray-500">
                        {result.completedAt.toLocaleDateString(language === 'es' ? 'es-ES' : 'en-US')}
                      </div>
                    </div>
